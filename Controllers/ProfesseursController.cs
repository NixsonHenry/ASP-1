...
namespace PAS.Controllers
{
    public class ProfesseursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProfesseurId,Nom,Prenom,Adresse,Phone,Sexe,Email")] Professeur professeur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProfesseurId,Nom,Prenom,Adresse,Phone,Sexe,Email")] Professeur professeur)
        {
